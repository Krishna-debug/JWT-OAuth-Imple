package com.krishna.JWT.controller;

import com.krishna.JWT.entity.UserRegisterEntity;

import com.krishna.JWT.service.UserRegisterEntityService;
...
public class UserController {
	...
	/*
	 * using this API to register the user into the system. username, password,
	 * role.
	 */
